...
//        readJsonTest(sc);
    ...
    static void readJsonTest(JavaSparkContext sc){
        JavaRDD<String> input = sc.textFile("/home/zhoujun/IdeaProjects/java/spark/src/main/resources/song.json");
    ...
    static void writeJsonTest(JavaSparkContext sc){
        ...
        result.foreach(x->System.out.println(x));
        formatted.saveAsTextFile("/home/zhoujun/IdeaProjects/java/spark/src/main/resources/song2.json");
    }
}
